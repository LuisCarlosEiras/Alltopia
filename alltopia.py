...
openai.api_key = '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'
...
with col2:
    ...
    fig = px.bar(df, x='Característica', y='Valor', 
                 ...
                 height=400,
                 color='Característica',  # Usar a coluna 'Característica' para definir as cores
                 color_discrete_sequence=color_palette)  # Usar a paleta de cores personalizada
    
    fig.update_layout(xaxis_tickangle=-45, showlegend=False)  # Remover a legenda
...
st.markdown('<p class="subtitle">Classificação da sua sociedade</p>', unsafe_allow_html=True)
...
if st.button("Analise sua sociedade com OpenAI"):
    ...
    st.subheader("Análise da sua sociedade pelo OpenAI")
...
st.markdown("""
    <div style="text-align: center; padding: 20px; background-color: #f0f2f6; margin-top: 30px;">
        <p>Altere as características acima para gerar nova sociedade utópica</p>
    </div>
    """, unsafe_allow_html=True)
